...
def main():
    ...
    主函数：加载文件，执行匹配，打印结果。
    """
    signature_file = "/home/hyj/deviceIdentification/dataset/MonIoTr/17_signatureMerge/uk/uk_merged_signatures_originalFile.csv"
    test_file = "/home/hyj/deviceIdentification/dataset/testData/featureCsvNew/uk/roku-tv/part1.csv"
    output_file = "/home/hyj/deviceIdentification/dataset/testData/featureCsv/matching_results.csv"  # 保存匹配结果的文件路径
