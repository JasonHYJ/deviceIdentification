...
def main():
    input_dir = "/home/hyj/deviceIdentification/dataset/LabData/16_keyPacketSignatureWithLSH"  # 输入的总文件夹路径
    output_dir = "/home/hyj/deviceIdentification/dataset/LabData/17_signatureMerge"  # 新的输出目录
