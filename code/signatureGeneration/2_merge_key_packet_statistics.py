...
if __name__ == "__main__":
    input_dir = "/home/hyj/deviceIdentification/dataset/LabData/13_keyPacketStatistics"  # 替换为设备 CSV 文件的路径
    output_dir = "/home/hyj/deviceIdentification/dataset/LabData/14_keyPacketMerge"  # 替换为输出文件夹路径
