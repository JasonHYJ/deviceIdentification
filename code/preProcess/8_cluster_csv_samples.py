...
def main():
    # 原始的 CSV 文件根目录
    root_folder = '/home/hyj/deviceIdentification/dataset/LabData/10_featureMerge'
    # 输出的根目录
    output_root_folder = '/home/hyj/deviceIdentification/dataset/LabData/11_featureCluster'  # 替换为你的目标输出路径
