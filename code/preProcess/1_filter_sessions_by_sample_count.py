...
def main():
    src_folder = '/home/hyj/deviceIdentification/dataset/LabData/3_selectDir'  # 源文件夹路径
    dst_folder = '/home/hyj/deviceIdentification/dataset/LabData/4_suitableDir'  # 目标文件夹路径
