...
if __name__ == "__main__":
    root_directory = "/home/hyj/deviceIdentification/dataset/LabData/8_csvSelect"  # 原始文件夹路径
    new_directory = "/home/hyj/deviceIdentification/dataset/LabData/9_feature"  # 新文件夹路径
